...
setup(
    ...
    # `packages=[]` is load-bearing: without it setuptools' flat-layout auto-discovery
    # inspects the tree, decides the project has packages to install, and refuses to
    # build. We are building exactly one extension module in place -- there is no
